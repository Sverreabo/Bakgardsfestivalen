...
<main class="container">
	<div class="program">
		<h2>Fredag 10.6 - kl 18.00-20.30</h2>
		<ul>
			<li>
			...
			<li>
				...
				<p>Marta Breen: Kommentar ved Rønnaug Sørensen. Vert: Norunn Askeland.</p>
			</li>
			<li>
	...
	<div class="program">
		<h2>Lørdag 11.6 - kl 18.00-20.30</h2>
		<ul>
			<li>
				<h3>Unge stemmer</h3>
				<p>
					Ungdom leser egne tekster om tilhørighet og geografi. Verter: Ingunn U-M Rasting og Ragnar
					Gjertsen.
				</p>
			</li>
			<li>
